...
main() {
  ...
  while (offset_count > 0) {
    ...
    val11 = val11 & 0xff;
    val12 = (val11 ^ 0x81) & 0x800000ff;

    if (val12 < val11) {
      val12 = (((val12 - 1) | 0xffffff00) + 1);
    }
    val12 = val12 & 0xff;
    val13 = (val12 ^ 0x23) & 0x800000ff;
